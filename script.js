...
function createEventCard(event, isPastEvent = false) {
  ...
  return `
    ...
    isPastEvent ? "past-event-image" : "event-image"
            ...
            <div class="${
              isPastEvent ? "past-event-details" : "event-details"
                ...
                <p class="${isPastEvent ? "past-event-time" : "event-time"}">${
    event.time || "Time not specified"
                ...
                <p class="${
                  isPastEvent ? "past-event-description" : "event-description"
                }">${event.description || "No description available"}</p>
                <a href="${
                  event.website || "#"
                }" target="_blank" rel="noopener noreferrer" class="${buttonClass}">${buttonText}</a>
            </div>
        </div>
    `;
}
